...
public class UserController {
	...
	//Redis'e kullanici id ve userDetails(id ,name ,city) olarak yaziliyor
	@PutMapping("/user")
	public ResponseEntity<WSUserDetails> saveUserDetails(@RequestBody WSUserDetails request) {

		//Redis'e userDetails hashTable biciminde id ,request(serialize edilip string)  olarak yaziliyo
	...
	//user redis den aliniyor ,ve userObjesi olarak donduruluyor
	@GetMapping("/user/{id}")
